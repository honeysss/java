    ...
    <body>
        ...
        <div class="page-body">
            ...
            <div class="page-content">
                ...
                <form action="ModifyDeptServlet">
                    <fieldset>
                        <legend>修改部门</legend>
                        部门名称:
                        <% String deptName = (String)request.getAttribute("deptName");
                        	int deptId = Integer.parseInt(request.getAttribute("deptId").toString());
                        %>
                        <input type="text" id="departmentname" maxlength="20" name="deptName"
                        value="<%= deptName %>"/>
                        <input type="text" style="display:none;"  value="<%= deptId %>" name = "deptId"/>
                        <input type="submit" class="clickbutton" value="确认修改"/>
                    </fieldset>
                </form>
