            ...
            <div class="page-content">
                ...
                <table class="listtable">
                    ...
                    <tr>
                        ...
                        <td><%= mrDao.selectMrById(mList.get(i).getMrId()) %></td>
                        ...
                        <td>
                            ...
                            style="background-color: #f1e5e5"
                             href="SelectMyMeetingServlet?empId=<%=session.getAttribute("empId")%>&mId=<%= mList.get(i).getmId() %>&mName=<%= mList.get(i).getmName() %>">查看详细</a>
                            <a class="clickbutton" 
                            style="background-color: #f1e5e5"
